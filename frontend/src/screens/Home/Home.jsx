      ...
      <section className="instagram" aria-label="Instagram feed">
        <div className="container">
          ...
          <div className="insta-follow fade-up">
            <Link href="https://instagram.com/kalpavristi_coco_fab" className="btn-outline" target="_blank" rel="noopener noreferrer">
              Follow on Instagram
            </Link>
          </div>
        </div>
      ...
      {cookieVisible && (
        <div className="cookie-consent" role="dialog" aria-label="Cookie consent">
          <div className="cookie-content">
            <p>We use cookies to enhance your experience. By continuing, you agree to our <Link href="/privacy">Privacy Policy</Link>.</p>
