...
const PRODUCTS = [
  {
    id: 1,
    name: 'Curry Leaves Khakhra',
    description: 'Iron-rich, aromatic curry leaves for daily wellness',
    price: 215,
    originalPrice: 250,
    image: productCurry,
    inStock: true,
  ...
  },
  {
    id: 2,
    name: 'Methi Khakhra',
    description: 'Digestive wellness with traditional methi goodness',
    price: 215,
    originalPrice: 250,
    image: productMethi,
    inStock: true,
  ...
  },
  {
    id: 3,
    name: 'Garlic Khakhra',
    description: 'Savory garlic flavor for guilt-free snacking',
    price: 215,
    originalPrice: 250,
    image: productGarlic,
    inStock: true,
  ...
  },
  {
    ...
    description: 'Superfood moringa for immunity and vitality',
    price: 215,
    originalPrice: 250,
...
const TESTIMONIALS = [
  {
    ...
    name: 'Anjali Sharma',
    location: 'Delhi',
    text: 'After years of digestive issues, WIN-DIA khakhras have been a game-changer. Light, crispy, and actually healthy!',
    rating: 5
  },
  {
    id: 2,
    name: 'Rajesh Mehta',
    location: 'Mumbai',
    text: 'My father is diabetic and loves these. Low GI means he can enjoy them without worry.',
    rating: 5
  },
  {
    id: 3,
    name: 'Priya Nair',
    location: 'Bengaluru',
    text: 'Finally a gluten-free snack that tastes amazing. The moringa flavor is my absolute favorite!',
    rating: 5
  }
];
...
const INSTAGRAM_IMAGES = [insta1, insta2, insta3, insta4, insta5, insta6];
...
const writeStorage = (key, value) => {
  ...
  try {
    ...
    // Ignore storage errors silently for UX stability
  }
};

const readPlainStorage = (key) => {
...
const Home = () => {
  ...
  useEffect(() => {
    const animatedNodes = document.querySelectorAll(
      '.home .fade-up, .home .fade-left, .home .fade-right'
    );
    ...
    animatedNodes.forEach((node) => observerRef.current?.observe(node));
        ...
        <div className="announcement-bar" role="alert">
          <div className="announcement-content">
            <span className="announcement-text">
              Enjoy Free Shipping on orders above ₹499 | Use code: WINDIA10 for 10% off on first order
            </span>
            <button
      ...
      <section className="featured-products" aria-label="Featured products">
        <div className="container">
          ...
          <div className="view-all fade-up">
            <Link href="/shop" className="btn-secondary">View Complete Collection</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="process-grid">
            {PROCESS_STEPS.map((step, index) => (
              <div key={step.title} className="process-card fade-up">
      ...
      <section className="trust" aria-label="Trust indicators">
        <div className="container">
          <div className="section-header fade-up">
            ...
            <p className="section-subtitle">
              Every product meets the highest standards of quality and safety
            </p>
          </div>
      ...
      <section className="testimonials" aria-label="Customer testimonials">
        <div className="container">
          <div className="section-header fade-up">
            ...
            <p className="section-subtitle">
              Hear from our customers who transformed their snacking habits
            </p>
          </div>
          ...
          <div className="reviews-link fade-up">
            <Link href="/reviews" className="btn-outline-small">Read 500+ 5-Star Reviews</Link>
          </div>
        </div>
      </section>
          ...
          <div className="founder-grid">
            ...
            <div className="founder-content fade-right">
              ...
              <div className="founder-quote">
                <p>
                  &quot;WIN-DIA was born from a simple idea — snacking should feel light, not heavy.
                  We&apos;ve reimagined traditional khakhra for modern wellness.&quot;
                </p>
              </div>
              <div className="founder-stats">
                ...
                <div>
                  <strong>KTech Elevate Winner</strong>
                  <span>Startup Karnataka</span>
                </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="instagram-grid">
            {INSTAGRAM_IMAGES.map((img, index) => (
              <div
                key={img}
                className="instagram-item fade-up"
                style={{ animationDelay: `${index * 0.08}s` }}
              >
          ...
          <div className="insta-follow fade-up">
            <Link
              href="https://instagram.com/kalpavristi_coco_fab"
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-col">
              ...
              <p className="footer-desc">
                Ancient wisdom meets modern wellness. Crafted with love, backed by science.
              </p>
            </div>
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-copyright">
              <p>
                © 2024 WIN-DIA. All rights reserved. Manufactured by Kalpavristi Coco Foods OPC Pvt. Ltd.
              </p>
            </div>
          </div>
        </div>
